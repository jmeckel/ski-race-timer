...
export const translations: Record<Language, Translations> = {
  en: {
    ...
    autoFinishTiming: 'Auto Finish Timing',
    autoFinishTimingDesc: 'Use the camera to auto-trigger finish timestamps',
    autoFinishStatusIdle: 'Auto timing idle',
    autoFinishStatusArmed: 'Auto timing armed',
    autoFinishStatusPaused: 'Auto timing paused',
    autoFinishStatusTriggered: 'Auto timing triggered',
    autoFinishLinePosition: 'Line position',
    autoFinishGateWidth: 'Gate width',
    autoFinishSensitivity: 'Sensitivity',
  ...
  de: {
    ...
    autoFinishTiming: 'Auto-Zielzeit',
    autoFinishTimingDesc: 'Kamera zur automatischen Zielzeit nutzen',
    autoFinishStatusIdle: 'Auto-Zeit bereit',
    autoFinishStatusArmed: 'Auto-Zeit aktiv',
    autoFinishStatusPaused: 'Auto-Zeit pausiert',
    autoFinishStatusTriggered: 'Auto-Zeit ausgelöst',
    autoFinishLinePosition: 'Linienposition',
    autoFinishGateWidth: 'Torbreite',
    autoFinishSensitivity: 'Empfindlichkeit',
