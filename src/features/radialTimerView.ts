...
import { RadialDial, showToast } from '../components';
...
async function recordRadialTimestamp(): Promise<void> {
  ...
  try {
    ...
    // Visual feedback
    showRadialConfirmation(entry, isDuplicate);
 ...
 */
function showRadialConfirmation(entry: Entry, _isDuplicate: boolean): void {
