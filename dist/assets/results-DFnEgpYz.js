var me=Object.defineProperty;var pe=(d,e,s)=>e in d?me(d,e,{enumerable:!0,configurable:!0,writable:!0,value:s}):d[e]=s;var g=(d,e,s)=>pe(d,typeof e!="symbol"?e+"":e,s);import{r as Z,u as fe,s as w,w as U,x as Y,y as _,t as v,z as be,e as L,A as V,B as ne,k as Q,C as W,D as G,E as oe,F as A,G as J,H as ve,I as z,J as O,g as re,K as ae,$ as ge,M as we,N as ye,O as ke,P as ce,a as q,Q as xe,L as Ee,o as E,R as Ce,p as de,S as Ie,T as Le}from"./chief-judge-c27My7qw.js";import{m as De}from"./vendor-signals-BzS5ZRDx.js";import{o as $e,c as Te,a as Se,b as Be}from"./gate-judge-CE30do39.js";const P=72,M=56,R=72,le=5,ue=16,Pe=33,Me=50,Re=100;function He(d){switch(d){case"critical":return Me;case"low":return Pe;default:return ue}}class Ae{constructor(e){g(this,"container");g(this,"scrollContainer");g(this,"contentContainer");g(this,"entries",[]);g(this,"groups",[]);g(this,"expandedGroups",new Set);g(this,"visibleItems",new Map);g(this,"itemListeners",new Map);g(this,"scrollTop",0);g(this,"containerHeight",0);g(this,"options");g(this,"unsubscribe",null);g(this,"resizeObserver",null);g(this,"scrollHandler",null);g(this,"scrollDebounceTimeout",null);g(this,"resizeDebounceTimeout",null);g(this,"isPaused",!1);g(this,"needsRefreshOnResume",!1);g(this,"isDestroyed",!1);g(this,"domRemovalObserver",null);g(this,"scrollDebounceDelay",ue);g(this,"unsubscribeBattery",null);this.options=e,this.container=e.container,this.scrollContainer=document.createElement("div"),this.scrollContainer.className="virtual-scroll-container",this.scrollContainer.style.cssText=`
      height: 100%;
      overflow-y: auto;
      overflow-x: hidden;
      -webkit-overflow-scrolling: touch;
    `,this.contentContainer=document.createElement("div"),this.contentContainer.className="virtual-scroll-content",this.contentContainer.style.position="relative",this.scrollContainer.appendChild(this.contentContainer),this.container.appendChild(this.scrollContainer),this.scrollHandler=()=>{this.scrollDebounceTimeout!==null&&clearTimeout(this.scrollDebounceTimeout),this.scrollDebounceTimeout=setTimeout(()=>{this.scrollDebounceTimeout=null;try{this.onScroll()}catch(t){Z.error("VirtualList scroll error:",t)}},this.scrollDebounceDelay)},this.scrollContainer.addEventListener("scroll",this.scrollHandler,{passive:!0}),this.unsubscribeBattery=fe.subscribe(t=>{this.scrollDebounceDelay=He(t.batteryLevel)}),this.resizeObserver=new ResizeObserver(()=>{this.resizeDebounceTimeout!==null&&clearTimeout(this.resizeDebounceTimeout),this.resizeDebounceTimeout=setTimeout(()=>{this.resizeDebounceTimeout=null;try{this.containerHeight=this.scrollContainer.clientHeight,this.isPaused?this.needsRefreshOnResume=!0:this.render()}catch(t){Z.error("VirtualList resize error:",t)}},Re)}),this.resizeObserver.observe(this.scrollContainer),this.unsubscribe=De(()=>{const t=ge.value;we.value,ye.value,this.setEntries(t)}),this.domRemovalObserver=new MutationObserver(t=>{var o;for(const i of t)for(const a of i.removedNodes)if(a===this.container||(o=a.contains)!=null&&o.call(a,this.container)){this.destroy();return}});const s=this.container.parentElement||document.body;this.domRemovalObserver.observe(s,{childList:!0,subtree:!0}),this.containerHeight=this.scrollContainer.clientHeight}setEntries(e){this.entries=e,this.applyFilters()}applyFilters(e,s,t){var c;this.scrollDebounceTimeout!==null&&(clearTimeout(this.scrollDebounceTimeout),this.scrollDebounceTimeout=null);const o=w.getState();let i=[...this.entries];if(e){const n=e.toLowerCase();i=i.filter(l=>{var r;return l.bib.toLowerCase().includes(n)||((r=l.deviceName)==null?void 0:r.toLowerCase().includes(n))})}s&&s!=="all"&&(i=i.filter(n=>n.point===s)),t&&t!=="all"&&(i=i.filter(n=>n.status===t));const a=new Map;for(const n of i){const l=n.run??1,r=`${n.bib}-${l}`;a.has(r)||a.set(r,{id:r,bib:n.bib,run:l,entries:[],faults:[],isMultiItem:!1,latestTimestamp:n.timestamp,crossDeviceDuplicateCount:0});const m=a.get(r);m.entries.push(n),new Date(n.timestamp)>new Date(m.latestTimestamp)&&(m.latestTimestamp=n.timestamp)}for(const n of o.faultEntries){const l=`${n.bib}-${n.run}`;if(e){const m=e.toLowerCase();if(!n.bib.toLowerCase().includes(m)&&!((c=n.deviceName)!=null&&c.toLowerCase().includes(m)))continue}if(s&&s!=="all"||t&&t!=="all"&&t!=="dsq"&&t!=="flt")continue;a.has(l)||a.set(l,{id:l,bib:n.bib,run:n.run,entries:[],faults:[],isMultiItem:!1,latestTimestamp:n.timestamp,crossDeviceDuplicateCount:0});const r=a.get(l);r.faults.push(n),new Date(n.timestamp)>new Date(r.latestTimestamp)&&(r.latestTimestamp=n.timestamp)}for(const n of a.values()){const l=n.entries.length+n.faults.length;n.isMultiItem=l>1;const r=new Map;for(const u of n.entries){const h=u.point;r.has(h)||r.set(h,new Set),r.get(h).add(u.deviceId)}let m=0;for(const u of r.values())u.size>1&&m++;n.crossDeviceDuplicateCount=m}this.groups=Array.from(a.values()).sort((n,l)=>{const r=parseInt(n.bib,10)||0;return(parseInt(l.bib,10)||0)-r});for(const[n,l]of this.visibleItems)this.cleanupItemListeners(n,l),l.remove();this.visibleItems.clear(),this.updateContentHeight(),this.isPaused?this.needsRefreshOnResume=!0:this.render()}toggleGroup(e){this.expandedGroups.has(e)?this.expandedGroups.delete(e):this.expandedGroups.add(e);for(const[s,t]of this.visibleItems)this.cleanupItemListeners(s,t),t.remove();this.visibleItems.clear(),this.updateContentHeight(),this.isPaused?this.needsRefreshOnResume=!0:this.render()}updateContentHeight(){let e=0;for(const s of this.groups)if(!s.isMultiItem)e+=P;else if(this.expandedGroups.has(s.id)){const t=s.entries.length+s.faults.length;e+=R+t*M}else e+=R;this.contentContainer.style.height=`${e}px`}getGroupHeight(e){if(!e.isMultiItem)return P;if(this.expandedGroups.has(e.id)){const s=e.entries.length+e.faults.length;return R+s*M}return R}onScroll(){this.scrollTop=this.scrollContainer.scrollTop,this.isPaused?this.needsRefreshOnResume=!0:this.render()}render(){if(this.groups.length===0){this.renderEmpty();return}const e=this.contentContainer.querySelector(".empty-state");e&&e.remove();const s=new Set,t=this.scrollTop,o=this.scrollTop+this.containerHeight;let i=0;for(let a=0;a<this.groups.length;a++){const c=this.groups[a],n=this.getGroupHeight(c);i+n>=t-le*P&&i<=o+le*P&&(c.isMultiItem?this.expandedGroups.has(c.id)?this.renderExpandedGroup(c,i,s):this.renderCollapsedGroup(c,i,s):this.renderSingleItem(c,i,s)),i+=n}for(const[a,c]of this.visibleItems)s.has(a)||(this.cleanupItemListeners(a,c),c.remove(),this.visibleItems.delete(a))}renderSingleItem(e,s,t){const o=`single-${e.id}`;t.add(o);let i=this.visibleItems.get(o);if(!i){if(e.entries.length>0)i=this.createEntryItem(e.entries[0],e.faults,o,e.crossDeviceDuplicateCount);else if(e.faults.length>0)i=this.createFaultOnlyItem(e,o);else return;this.visibleItems.set(o,i),this.contentContainer.appendChild(i)}i.style.transform=`translateY(${s}px)`}renderCollapsedGroup(e,s,t){const o=`header-${e.id}`;t.add(o);let i=this.visibleItems.get(o);i||(i=this.createGroupHeader(e,!1),this.visibleItems.set(o,i),this.contentContainer.appendChild(i)),i.style.transform=`translateY(${s}px)`}renderExpandedGroup(e,s,t){const o=`header-${e.id}`;t.add(o);let i=this.visibleItems.get(o);i||(i=this.createGroupHeader(e,!0),this.visibleItems.set(o,i),this.contentContainer.appendChild(i)),i.style.transform=`translateY(${s}px)`;let a=s+R;for(let c=0;c<e.entries.length;c++){const n=e.entries[c],l=`sub-entry-${n.id}`;t.add(l);let r=this.visibleItems.get(l);r||(r=this.createSubEntryItem(n,l),this.visibleItems.set(l,r),this.contentContainer.appendChild(r)),r.style.transform=`translateY(${a}px)`,a+=M}for(let c=0;c<e.faults.length;c++){const n=e.faults[c],l=`sub-fault-${n.id}`;t.add(l);let r=this.visibleItems.get(l);r||(r=this.createSubFaultItem(n,l),this.visibleItems.set(l,r),this.contentContainer.appendChild(r)),r.style.transform=`translateY(${a}px)`,a+=M}}createGroupHeader(e,s){const t=document.createElement("div");t.className=`result-group-header ${s?"expanded":""}`,t.setAttribute("data-group-id",e.id),t.setAttribute("role","button"),t.setAttribute("tabindex","0"),t.setAttribute("aria-expanded",String(s)),t.style.cssText=`
      position: absolute;
      left: 0;
      right: 0;
      height: ${R}px;
    ...
    `;const o=U(e.bib||"---"),a=w.getState().currentLang,c=Y(e.run),n=_(e.run,a),l=e.entries.length,r=e.faults.length,m=r>0,u=[];l>0&&u.push(`${l} ${v(l===1?"timeEntry":"timeEntries",a)}`),r>0&&u.push(`${r} ${v(r===1?"faultEntry":"faultEntries",a)}`);const h=u.join(", ");t.innerHTML=`
      ${be(16,s)}
    ...
    `;const p=`header-${e.id}`,y={};return y.click=()=>{this.toggleGroup(e.id)},t.addEventListener("click",y.click),y.keydown=(D=>{switch(D.key){case"Enter":case" ":D.preventDefault(),this.toggleGroup(e.id);break;case"ArrowDown":D.preventDefault(),this.focusNextItem(t);break;case"ArrowUp":D.preventDefault(),this.focusPreviousItem(t);break}}),t.addEventListener("keydown",y.keydown),this.itemListeners.set(p,y),t}createEntryItem(e,s,t,o=0){const i=document.createElement("div");i.className="result-item",i.setAttribute("role","listitem"),i.setAttribute("tabindex","0"),i.setAttribute("data-entry-id",e.id),i.style.cssText=`
      ...
      cursor: pointer;
      transition: background 0.2s;
    `;const a=new Date(e.timestamp),c=Q(a),n=U(e.bib||"---"),r=w.getState().currentLang,m=W(e.point),u=G(e.point,r),h=e.run??1,p=Y(h),y=_(h,r),D=s.length>0?oe({faults:s,lang:r}):"",C=o>0?ne(r):"";i.innerHTML=`
    ...
    `;const k={},B=i.querySelector(".result-edit-btn");k.editBtn=B,k.editClick=(f=>{var b,I;f.stopPropagation(),(I=(b=this.options).onItemClick)==null||I.call(b,e,f)}),B.addEventListener("click",k.editClick);const H=i.querySelector(".result-delete");k.deleteBtn=H,k.deleteClick=(f=>{var b,I;f.stopPropagation(),(I=(b=this.options).onItemDelete)==null||I.call(b,e)}),H.addEventListener("click",k.deleteClick);const x=i.querySelector(".result-photo-btn");return x&&(k.photoBtn=x,k.photoClick=(f=>{var b,I;f.stopPropagation(),(I=(b=this.options).onViewPhoto)==null||I.call(b,e)}),x.addEventListener("click",k.photoClick)),k.click=(f=>{var b,I;(I=(b=this.options).onItemClick)==null||I.call(b,e,f)}),i.addEventListener("click",k.click),k.keydown=(f=>{var I,X,ee,te,se,ie;const b=f;switch(b.key){case"Enter":case" ":b.preventDefault(),(X=(I=this.options).onItemClick)==null||X.call(I,e,new MouseEvent("click"));break;case"e":case"E":b.preventDefault(),(te=(ee=this.options).onItemClick)==null||te.call(ee,e,new MouseEvent("click"));break;case"Delete":case"d":case"D":b.preventDefault(),(ie=(se=this.options).onItemDelete)==null||ie.call(se,e);break;case"ArrowDown":b.preventDefault(),this.focusNextItem(i);break;case"ArrowUp":b.preventDefault(),this.focusPreviousItem(i);break}}),i.addEventListener("keydown",k.keydown),this.itemListeners.set(t,k),i}createFaultOnlyItem(e,s){var H;const t=document.createElement("div"),o=e.faults,i=o.some(x=>x.markedForDeletion);t.className=`result-item fault-only-item${i?" marked-for-deletion":""}`,t.setAttribute("role","listitem"),t.setAttribute("tabindex","0"),t.setAttribute("data-fault-id",e.id),t.style.cssText=`
      ...
      ${i?"opacity: 0.6;":""}
      cursor: pointer;
    `;const a=U(e.bib||"---"),c=w.getState(),n=c.currentLang,l=Y(e.run),r=_(e.run,n),m=o.sort((x,f)=>x.gateNumber-f.gateNumber).map(x=>`T${x.gateNumber} (${re(x.faultType,n)})${x.markedForDeletion?" ⚠":""}`).join(", "),u=oe({faults:o,lang:n}),h=c.usePenaltyMode?v("flt",n):v("dsq",n),p=c.usePenaltyMode?"var(--warning)":"var(--error)",y=p==="var(--warning)"?"#000":"white",D=i?ae():"";t.innerHTML=`
      <div style="width: 16px; flex-shrink: 0;"></div>
    ...
    `;const C={},k=t.querySelector(".result-edit-btn");k&&o.length>0&&(C.editBtn=k,C.editClick=(x=>{x.stopPropagation();const f=new CustomEvent("fault-edit-request",{bubbles:!0,detail:{fault:o[0]}});t.dispatchEvent(f)}),k.addEventListener("click",C.editClick));const B=t.querySelector(".fault-delete-btn");return B&&o.length>0&&(C.deleteBtn=B,C.deleteClick=(x=>{x.stopPropagation();const f=new CustomEvent("fault-delete-request",{bubbles:!0,detail:{fault:o[0]}});t.dispatchEvent(f)}),B.addEventListener("click",C.deleteClick)),C.click=(x=>{const f=x.target;if(!(f.closest(".fault-delete-btn")||f.closest(".result-edit-btn"))&&o.length>0){const b=new CustomEvent("fault-edit-request",{bubbles:!0,detail:{fault:o[0]}});t.dispatchEvent(b)}}),t.addEventListener("click",C.click),C.keydown=(x=>{const f=x;switch(f.key){case"Enter":case" ":case"e":case"E":if(f.preventDefault(),o.length>0){const b=new CustomEvent("fault-edit-request",{bubbles:!0,detail:{fault:o[0]}});t.dispatchEvent(b)}break;case"Delete":case"d":case"D":if(f.preventDefault(),o.length>0){const b=new CustomEvent("fault-delete-request",{bubbles:!0,detail:{fault:o[0]}});t.dispatchEvent(b)}break;case"ArrowDown":f.preventDefault(),this.focusNextItem(t);break;case"ArrowUp":f.preventDefault(),this.focusPreviousItem(t);break}}),t.addEventListener("keydown",C.keydown),this.itemListeners.set(s,C),t}createSubEntryItem(e,s){const t=document.createElement("div");t.className="result-sub-item entry-sub-item",t.setAttribute("role","listitem"),t.setAttribute("tabindex","0"),t.setAttribute("data-entry-id",e.id),t.style.cssText=`
      ...
      cursor: pointer;
      transition: background 0.2s;
    `;const o=new Date(e.timestamp),i=Q(o),c=w.getState().currentLang,n=W(e.point),l=G(e.point,c);t.innerHTML=`
      <div style="width: 16px; flex-shrink: 0;"></div>
    ...
    `;const r={},m=t.querySelector(".result-edit-btn");r.editBtn=m,r.editClick=(h=>{var p,y;h.stopPropagation(),(y=(p=this.options).onItemClick)==null||y.call(p,e,h)}),m.addEventListener("click",r.editClick);const u=t.querySelector(".result-delete");return r.deleteBtn=u,r.deleteClick=(h=>{var p,y;h.stopPropagation(),(y=(p=this.options).onItemDelete)==null||y.call(p,e)}),u.addEventListener("click",r.deleteClick),r.click=(h=>{var p,y;(y=(p=this.options).onItemClick)==null||y.call(p,e,h)}),t.addEventListener("click",r.click),r.keydown=(h=>{var y,D,C,k;const p=h;switch(p.key){case"Enter":case" ":case"e":case"E":p.preventDefault(),(D=(y=this.options).onItemClick)==null||D.call(y,e,new MouseEvent("click"));break;case"Delete":case"d":case"D":p.preventDefault(),(k=(C=this.options).onItemDelete)==null||k.call(C,e);break;case"ArrowDown":p.preventDefault(),this.focusNextItem(t);break;case"ArrowUp":p.preventDefault(),this.focusPreviousItem(t);break}}),t.addEventListener("keydown",r.keydown),this.itemListeners.set(s,r),t}createSubFaultItem(e,s){const t=document.createElement("div"),o=e.markedForDeletion;t.className=`result-sub-item fault-sub-item${o?" marked-for-deletion":""}`,t.setAttribute("role","listitem"),t.setAttribute("tabindex","0"),t.setAttribute("data-fault-id",e.id),t.style.cssText=`
      ...
      cursor: pointer;
      transition: background 0.2s;
    `;const a=w.getState().currentLang,c=w.getGateColor(e.gateNumber),n=c==="red"?"#ef4444":"#3b82f6";t.innerHTML=`
      <div style="width: 16px; flex-shrink: 0;"></div>
      <div style="min-width: 44px;"></div>
    ...
    `;const l={},r=t.querySelector(".result-edit-btn");l.editBtn=r,l.editClick=(u=>{u.stopPropagation();const h=new CustomEvent("fault-edit-request",{bubbles:!0,detail:{fault:e}});t.dispatchEvent(h)}),r.addEventListener("click",l.editClick);const m=t.querySelector(".fault-delete-btn");return l.deleteBtn=m,l.deleteClick=(u=>{u.stopPropagation();const h=new CustomEvent("fault-delete-request",{bubbles:!0,detail:{fault:e}});t.dispatchEvent(h)}),m.addEventListener("click",l.deleteClick),l.click=(()=>{const u=new CustomEvent("fault-edit-request",{bubbles:!0,detail:{fault:e}});t.dispatchEvent(u)}),t.addEventListener("click",l.click),l.keydown=(u=>{const h=u;switch(h.key){case"Enter":case" ":case"e":case"E":h.preventDefault();{const p=new CustomEvent("fault-edit-request",{bubbles:!0,detail:{fault:e}});t.dispatchEvent(p)}break;case"Delete":case"d":case"D":h.preventDefault();{const p=new CustomEvent("fault-delete-request",{bubbles:!0,detail:{fault:e}});t.dispatchEvent(p)}break;case"ArrowDown":h.preventDefault(),this.focusNextItem(t);break;case"ArrowUp":h.preventDefault(),this.focusPreviousItem(t);break}}),t.addEventListener("keydown",l.keydown),this.itemListeners.set(s,l),t}renderEmpty(){for(const s of this.visibleItems.values())s.remove();this.visibleItems.clear();const e=w.getState();this.contentContainer.innerHTML=`
      <div class="empty-state">
        <span class="empty-icon">⏱️</span>
        <span>${v("noEntries",e.currentLang)}</span>
        <span class="empty-subtitle">${v("noEntriesHint",e.currentLang)}</span>
      </div>
    `}pause(){this.isPaused=!0}resume(){this.isPaused=!1,this.needsRefreshOnResume&&(this.needsRefreshOnResume=!1,this.render())}scrollToTop(){this.scrollContainer.scrollTo({top:0,behavior:"smooth"})}scrollToEntry(e){const s=String(e),t=this.groups.find(i=>i.entries.some(a=>a.id===s));if(!t)return;let o=0;for(const i of this.groups){if(i.id===t.id)break;o+=this.getGroupHeight(i)}t.isMultiItem&&(this.expandedGroups.add(t.id),this.isPaused?this.needsRefreshOnResume=!0:this.render()),this.isPaused||this.scrollContainer.scrollTo({top:o,behavior:"smooth"})}getVisibleCount(){return this.groups.reduce((e,s)=>e+s.entries.length,0)}getSortedFocusableItems(){const e=Array.from(this.visibleItems.values());return e.sort((s,t)=>{const o=this.getItemYPosition(s),i=this.getItemYPosition(t);return o-i}),e}focusNextItem(e){const s=this.getSortedFocusableItems(),t=s.indexOf(e);t>=0&&t<s.length-1&&s[t+1].focus()}focusPreviousItem(e){const s=this.getSortedFocusableItems(),t=s.indexOf(e);t>0&&s[t-1].focus()}getItemYPosition(e){const t=e.style.transform.match(/translateY\((\d+)px\)/);return t?parseInt(t[1],10):0}cleanupItemListeners(e,s){const t=this.itemListeners.get(e);t&&(t.click&&s.removeEventListener("click",t.click),t.keydown&&s.removeEventListener("keydown",t.keydown),t.editBtn&&t.editClick&&t.editBtn.removeEventListener("click",t.editClick),t.deleteBtn&&t.deleteClick&&t.deleteBtn.removeEventListener("click",t.deleteClick),t.photoBtn&&t.photoClick&&t.photoBtn.removeEventListener("click",t.photoClick),this.itemListeners.delete(e))}destroy(){if(!this.isDestroyed){this.isDestroyed=!0,this.domRemovalObserver&&(this.domRemovalObserver.disconnect(),this.domRemovalObserver=null),this.scrollHandler&&(this.scrollContainer.removeEventListener("scroll",this.scrollHandler),this.scrollHandler=null),this.scrollDebounceTimeout!==null&&(clearTimeout(this.scrollDebounceTimeout),this.scrollDebounceTimeout=null),this.resizeDebounceTimeout!==null&&(clearTimeout(this.resizeDebounceTimeout),this.resizeDebounceTimeout=null),this.resizeObserver&&(this.resizeObserver.disconnect(),this.resizeObserver=null),this.unsubscribe&&(this.unsubscribe(),this.unsubscribe=null),this.unsubscribeBattery&&(this.unsubscribeBattery(),this.unsubscribeBattery=null);for(const[e,s]of this.visibleItems)this.cleanupItemListeners(e,s);this.visibleItems.clear(),this.itemListeners.clear(),this.scrollContainer.remove()}}}let F=null;async function ze(d){const e=document.getElementById("photo-viewer-modal");if(!e||!d.photo)return;F=d.id;const s=document.getElementById("photo-viewer-image"),t=document.getElementById("photo-viewer-bib"),o=document.getElementById("photo-viewer-point"),i=document.getElementById("photo-viewer-time"),c=w.getState().currentLang;if(s){const n=G(d.point,c);if(s.alt=`${v("photoForBib",c)} ${d.bib||"---"} - ${n}`,ke(d.photo)){s.src="";const l=await ce.getPhoto(d.id);if(l)s.src=`data:image/jpeg;base64,${l}`;else{Z.warn("Photo not found in IndexedDB for entry:",d.id);return}}else s.src=`data:image/jpeg;base64,${d.photo}`}if(t&&(t.textContent=d.bib||"---"),o){o.textContent=G(d.point,c);const n=W(d.point);o.style.background=n,o.style.color="var(--background)"}if(i){const n=new Date(d.timestamp);i.textContent=Q(n)}$e(e)}function Oe(){const d=document.getElementById("photo-viewer-modal");Te(d),F=null}async function Je(){if(!F)return;const d=w.getState(),e=F;await ce.deletePhoto(e),w.updateEntry(e,{photo:void 0}),Oe(),q(v("photoDeleted",d.currentLang),"success"),xe()}let T=null,N=null,S=null;const $=new Ee;function Ne(d){window.dispatchEvent(new CustomEvent("open-edit-modal",{detail:{entry:d}}))}function Ge(d){window.dispatchEvent(new CustomEvent("prompt-delete",{detail:{entry:d}}))}function j(d){window.dispatchEvent(new CustomEvent("open-confirm-modal",{detail:{action:d}}))}function je(){return T}function Ke(){$.removeAll(),S&&(clearTimeout(S),S=null);const d=E("results-list");if(!d)return;T=new Ae({container:d,onItemClick:a=>Ne(a),onItemDelete:a=>Ge(a),onItemSelect:a=>{w.toggleEntrySelection(a.id)},onViewPhoto:a=>ze(a)}),$.add(d,"fault-edit-request",(a=>{var n;const c=(n=a.detail)==null?void 0:n.fault;c&&Se(c)})),$.add(d,"fault-delete-request",(a=>{var n;const c=(n=a.detail)==null?void 0:n.fault;c&&Be(c)}));const e=w.getState();T.setEntries(e.entries),he();const s=document.querySelector(".results-view");s&&(N=new Ce({container:s,onRefresh:async()=>{await de.forceRefresh(),q(v("syncReceived",w.getState().currentLang),"success")}}));const t=E("search-input");t&&$.add(t,"input",()=>{S&&clearTimeout(S),S=setTimeout(()=>{K()},300)});const o=E("filter-point"),i=E("filter-status");o&&$.add(o,"change",K),i&&$.add(i,"change",K),qe(),e.currentView!=="results"&&T&&T.pause()}function qe(){const d=E("clear-all-btn");d&&$.add(d,"click",()=>{const o=w.getState();if(o.entries.length===0){q(v("noEntries",o.currentLang),"info");return}j("clearAll")});const e=E("undo-btn");e&&$.add(e,"click",()=>{if(w.canUndo()){const o=w.peekUndo();if(o&&o.type==="ADD_ENTRY")j("undoAdd");else{const i=w.undo();Ie(),q(v("undone",w.getState().currentLang),"success");const a=w.getState();if(i&&i.type==="ADD_ENTRY"&&a.settings.sync&&a.raceId){const c=i.data;de.deleteEntryFromCloud(c.id,c.deviceId)}}}});const s=E("export-btn");s&&$.add(s,"click",Le);const t=E("delete-selected-btn");t&&$.add(t,"click",()=>{w.getState().selectedEntries.size>0&&j("deleteSelected")})}function K(){if(!T)return;const d=E("search-input"),e=E("filter-point"),s=E("filter-status");T.applyFilters((d==null?void 0:d.value)||"",(e==null?void 0:e.value)||"all",(s==null?void 0:s.value)||"all"),he()}function he(){const e=w.getState().entries,s=e.length,t=new Set(e.map(u=>u.bib)).size,o=new Set(e.filter(u=>u.point==="F"&&u.status==="ok").map(u=>u.bib)).size,i=new Map;for(const u of e){const h=`${u.bib}-${u.point}-${u.run??1}`;i.has(h)||i.set(h,new Set),i.get(h).add(u.deviceId)}let a=0;for(const u of i.values())u.size>1&&a++;const c=E("stat-total"),n=E("stat-racers"),l=E("stat-finished"),r=E("stat-duplicates"),m=E("stat-duplicates-item");c&&(c.textContent=String(s)),n&&(n.textContent=String(t)),l&&(l.textContent=String(o)),r&&(r.textContent=String(a)),m&&(m.style.display=a>0?"":"none")}function Ze(){const d=E("entry-count-badge");if(d){const e=w.getState().entries.length;d.textContent=String(e),d.style.display=e>0?"inline":"none"}}function Fe(){S&&(clearTimeout(S),S=null),$.removeAll(),N&&(N.destroy(),N=null),T&&(T.destroy(),T=null)}function Qe(){Fe()}export{Ze as a,Qe as b,Oe as c,Je as d,je as g,Ke as i,he as u};
